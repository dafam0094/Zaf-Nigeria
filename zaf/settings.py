"""
Django settings for zaf project.
...
SECRET_KEY = 'django-insecure-!*@7vuaeom@o_=$z()h1yg!69#la#mylg=nz=!(y%9esg=5gn7'
...
WSGI_APPLICATION = 'zaf.wsgi.application'
